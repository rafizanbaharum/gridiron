package net.canang.gridiron.web.config;
 ...
 */
@Configuration
@ComponentScan({"net.canang.gridiron.core", "net.canang.gridiron.biz", "net.canang.gridiron.web"})
@PropertySource("classpath:app.properties")
@EnableWebMvc
@EnableTransactionManagement
public class GridironWebConfiguration extends WebMvcConfigurerAdapter {
